...
/// Static data provider for the 66-book Recovery Version Bible catalogue.
@MainActor
enum BibleDataService {

    // MARK: - Book catalogue

    /// 66 canonical books in canonical order with Recovery Version chapter counts.
    ...
    /// Chapter numbers for a given book.
